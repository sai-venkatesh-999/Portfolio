        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="A scalable MERN stack e-commerce platform featuring product search, secure checkout, and responsive design. Integrated payment gateway and optimized for performance to ensure a seamless shopping experience.e"
              ghLink="https://github.com/sai-venkatesh-999/forever_Clone"
              demoLink="https://forever-clone-sigma.vercel.app/"              
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/sai-venkatesh-999/Gemini_clone"
              demoLink="https://gemini-clone-alpha-sandy-82.vercel.app/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/sai-venkatesh-999/Resume-Maker"
              demoLink="https://resume-maker-green-omega.vercel.app/"
            />
          </Col>
        </Row>
      </Container>
